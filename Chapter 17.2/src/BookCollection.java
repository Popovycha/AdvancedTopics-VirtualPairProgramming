...
public class BookCollection {
	...
	public Map<Integer, String> findBookTitles(Predicate<Book> searchCriteria) {
		List<Book> results = findBooks(searchCriteria);
		return results.stream().collect(Collectors.toMap(Book::getId,(Book b) ->b.getTitle()));
	}
	...
	public List<Book> findBooks(Predicate<Book> searchCriteria) {
		...
		//We did replace all this code below with one line in 15
